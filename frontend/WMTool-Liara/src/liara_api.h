...
typedef void (*LiaraApiStreamProgressCallback)(const char *progress_payload, gpointer user_data);
...
void liara_api_get_sys_audit_summary(
    LiaraApi *api,
    int limit,
...
void liara_api_get_sys_audit_suspicious(
    LiaraApi *api,
    int limit,
    int max_items,
    gboolean blocked_only,
...
void liara_api_get_sys_audit_preset(
    LiaraApi *api,
...
void liara_api_get_tool_metadata(
    LiaraApi *api,
